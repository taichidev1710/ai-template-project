...
export function FeatureDetailModal({ open, feature, canUpdate, onEdit, onClose }: Props) {
    ...
    >
      {feature && (
        <Descriptions column={1} bordered size="small">
          ...
          <Descriptions.Item label={t('feature.system')}>
            {feature.isSystem ? t('common.yes') : t('common.no')}
          </Descriptions.Item>
